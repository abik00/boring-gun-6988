        ...
        <Grid
            ...
            >
             <Flex justifyContent='space-evenly'>
                <Button textAlign='center' h='70px' width='150px' bg='white' 
                boxShadow= 'rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'
                borderTopLeftRadius={20}
                borderBottomRightRadius={20}
                _hover={{ bg: "white",boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}
                >
                
                <Image src='https://static.naukimg.com/s/0/0/i/trending-naukri/remote.svg' height={10}/> <p>Remote</p>
                
            </Button>
            <Button textAlign='center' h='70px' width='140px' bg='white' 
                boxShadow= 'rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'
                borderTopLeftRadius={20}
                borderBottomRightRadius={20}
                _hover={{ bg: "white",boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }} >
            ...
            <Button textAlign='center' h='70px' width='190px' bg='white' 
                boxShadow= 'rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'
                borderTopLeftRadius={20}
                borderBottomRightRadius={20}
                _hover={{ bg: "white",boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }} >
            ...
            <Button textAlign='center' h='70px' width='170px' bg='white' 
                boxShadow= 'rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'
                borderTopLeftRadius={20}
                borderBottomRightRadius={20}
                _hover={{ bg: "white",boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }} >
            ...
            <Button textAlign='center' h='70px' width='170px' bg='white' 
             ...
             <Button textAlign='center' h='70px' width='130px' mr={5} bg='white' 
                boxShadow= 'rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'
                borderTopLeftRadius={20}
                borderBottomRightRadius={20}
                _hover={{ bg: "white",boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
                ...
                <Button textAlign='center' h='70px' width='170px' mr={5}  bg='white' 
                boxShadow= 'rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'
                borderTopLeftRadius={20}
                borderBottomRightRadius={20}
                _hover={{ bg: "white",boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
            ...
            <Button textAlign='center' h='70px' width='190px'  mr={5} bg='white' 
                boxShadow= 'rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(27, 31, 35, 0.15) 0px 0px 0px 1px'
                borderTopLeftRadius={20}
                borderBottomRightRadius={20}
                _hover={{ bg: "white",boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px' }}>
